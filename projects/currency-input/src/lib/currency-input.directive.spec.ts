...
@Component({
  template: `
    <input id="input1" ecoCurrencyInput type="number" [(ngModel)]="value1"><span id="span1">{{value1}}</span>
    <input id="input2" ecoCurrencyInput type="number" [(ngModel)]="value2"><span id="span2">{{value2}}</span>
    <input id="input3" ecoCurrencyInput type="number" [(ngModel)]="value3" [smallestUnitPerUnit]="smallestUnitPerUnit"><span id="span3">{{value3}}</span>
    <input id="input4" ecoCurrencyInput type="number" [(ngModel)]="value4"><span id="span4">{{value4}}</span>
    <form name="reactiveForm" role="form" novalidate [formGroup]="form">
      <input id="inputR1" ecoCurrencyInput formControlName="value1" type="number" step="1"><span id="spanR1">{{form.get('value1').value}}</span>
      <input id="inputR2" ecoCurrencyInput formControlName="value2" type="number" step="2"><span id="spanR2">{{form.get('value2').value}}</span>
      <input id="inputR3" ecoCurrencyInput formControlName="value3" type="number" step="3" [smallestUnitPerUnit]="smallestUnitPerUnit"><span id="spanR3">{{form.get('value3').value}}</span>
      <input id="inputR4" ecoCurrencyInput formControlName="value4" type="number" step="4"><span id="spanR4">{{form.get('value4').value}}</span>
    </form>
  `
})
